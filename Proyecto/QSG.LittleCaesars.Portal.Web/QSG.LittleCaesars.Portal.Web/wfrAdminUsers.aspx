<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfrAdminUsers.aspx.cs" Inherits="QSG.LittleCaesars.Portal.Web.wfrAdminUsers" %>
<!DOCTYPE html>
...
<head id="Head1" runat="server">
   ...
   <script type="text/javascript" src="Scripts/wfrAdminUsers.js"></script>
            ...
            <div class="container-fluid"  >
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                 ...
                 <div class="content_buttons" >
                    ...
                    <asp:Button id="Reporte" runat="server"  CssClass="btnReport btnBuscar" title="Reporte"/>
                     ...
                     <!--   <div>
                      <!--
                         ...
                         <div class="_table" style="border:none;">
                             <span  style="background-color:transparent;">Datos del Usuario</span>
                             <ul class="content_table" id="content_usuario_detalle" runat="server">
                                 <li>
                                     <ul>
                                         <li class="column_codidoU">Codigo</li>
                                         <li class="column_NomUsuario">Nombre del Usuario<img class="_find" /></li>
                                         <li class="column_alias">Alias<img class="_find"/></li>
                                         <li class="column_perfil">Tipo de Perfil</li>
                                         <li class="column_email">correo</li>
                                         <li class="column_bloqueo">Bloqueo</li>
                                         <li class="column_resetpassword">Reiniciar Contraseña</li>
                                     </ul>
                                 </li>

                                 <li class="rowHead">
                                     <ul>
                                         <li class="column_codidoU"><input /></li>
                                         <li class="column_NomUsuario"><input /></li>
                                         <li class="column_alias"><input /></li>
                                         <li class="column_perfil"><input /></li>
                                         <li class="column_email"><input /></li>
                                         <li class="column_bloqueo"><img class="_unchecked" onclick="check(event);"/></li>
                                         <li class="column_resetpassword"><input type="button" value="reiniciar" /></li>
                                     </ul>
                                 </li>
                        ...
                        <div class="_table" id="content_Reptickets">
                          <span style="background-color:transparent;">Tabla de Facultades</span>
                           <ul class="content_table" id="content_usuario_ul" runat="server" >
                            
                               <li >
                                   <ul >
                                       
                                        <li class='column_App'> aplicacion</li>
                                        <li class='column_Modulo'> Modulo</li>
                                        <li class='column_pantalla' >pantalla</li>
                                        <li class='column_Permisos'>permisos

                                            <ul>
                                                <li class="column_P_view"><img class="_view" /></li>
                                                <li class="column_P_write"><img class="_write" /></li>
                                                <li class="column_P_print"><img class="_print" /></li>
                                                <li class="column_P_delete"><img class="_delete"/></li>
                               ...
                               <li class="row">
                                   <ul >
                                        ...
                                        <li class='column_App'> <input class="inactive"/></li>
                                        <li class='column_Modulo'> <input class="inactive" /></li>
                                        <li class='column_pantalla' ><input class="inactive" /></li>
                                       
                                        <li class="column_P_view"><img class="_unchecked" onclick="check(event);"/></li>
                                        <li class="column_P_write"><img class="_unchecked" onclick="check(event);"/></li>
                                        <li class="column_P_print"><img class="_unchecked" onclick="check(event);"/></li>
                                        <li class="column_P_delete"><img class="_unchecked" onclick="check(event);" /></li>
                               ...
                               <li class="row" >
                                   <ul >
                                        ...
                                        <li class='column_Empresa'> <input value="cesarmex sa de cv" /> </li>
                                        <li class='column_Banco'> <select><option>bancomer sade cv</option></select></li>
                                        <li class='column_Cuenta' ><input value="423423423423423423234" /></li>
                                        <li class='column_Moneda'><select><option>dolares</option></select></li>
                                        <li class='column_Titular'><input value="juan carlos gomez" /></li>
                                        <li class='column_Descripcion'><input value="titulñar de ñla ceunta" /></li>
                                        <li class='column_Nota'><input value="jajajajajaajj" /></li>
