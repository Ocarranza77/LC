<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfrCtasBanco.aspx.cs" Inherits="QSG.LittleCaesars.Portal.Web.wfrCtasBanco" %>
...
<head id="Head1" runat="server">
   ...
   <script type="text/javascript" src="Scripts/wfrCtasBanco.js"></script>
                           ...
                           <ul class="content_table" id="container_history" runat="server" >
                               ...
                               <li >
                                   <ul >
                                        ...
                                        <li class='column_Empresa'> Empresa</li>
                                        <li class='column_Banco'> Banco</li>
                                        <li class='column_Cuenta' >Cuenta</li>
                                        <li class='column_Moneda'>Moneda</li>
                                        <li class='column_Titular'>Titular</li>
                                        <li class='column_Descripcion'>Descripcion</li>
