...
namespace QSG.LittleCaesars.BackOffice.Common.SAT_XML_Entities
{
    public class zzGenerarXML
    {
        ...
        public string GuardarXMLPorCertificado(Comprobante c, string rutaCertificado, string rutaArchivoClavePrivada, string passwordClavePrivada, string rutaXMLToSave)
        {
        ...
        {
            string rutaXSLT = AppDomain.CurrentDomain.BaseDirectory + "\\XSLT\\cadenaoriginal.xslt";
