...
{
     public sealed class ConvertToLetter
    {
        /// <summary>
            ...
            private static string[,] _matriz = new string[CENTENA + 1, 10]
        {
            ...
            public const String MascaraSalidaDecimalDefault = "00'/100.MN'";
            ...
            public ConvertToLetter(Boolean ConvertirDecimales, String MascaraSalidaDecimal, String SeparadorDecimalSalida, Boolean LetraCapital)
            {
            ...
            {
                return ConvertToLetter.ToCardinal(Numero, CultureInfo.CurrentCulture);
            }
