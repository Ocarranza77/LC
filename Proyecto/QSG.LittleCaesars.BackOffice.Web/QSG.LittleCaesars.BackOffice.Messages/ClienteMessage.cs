...
namespace QSG.LittleCaesars.BackOffice.Messages
{
    public partial class ServiceImplementation
    {
        ...
        public ClienteResponse ClienteMessage(ClienteRequest request)
        {
            ...
            try
            {
                ...
                {
                    response.Cliente = bl.GetCliente(request.Cliente, ref msg);
                ...
                if (request.MessageOperationType == MessageOperationType.Save)
                {
                    if (request.Cliente != null)
                        if (!bl.SaveCliente(request.Cliente, ref msg))
                    ...
                    if (request.Clientes == null && request.Cliente == null)
